...
refs:
Gameplay Framework Quick Reference (UE5.1)
Game Mode and Game State (UE5.1)
...
BUTTON COMPONENT
This is the actual button. It moves when it's pressed, shows its state, and can trigger a function somewhere. There are many things set up by default, and there are many options
